# server.py — Federated server for Client7 Bert+RotatE (7 silos, PQ2H)
#
...
# MLP: 768 -> 512 -> 3584
#
# Key difference from Client7/Bert+TransE and Bert+DistMult:
...
class QuestionEncoder(nn.Module):
    """BERT [CLS] -> MLP -> q_embed in R^(14d=3584). BERT frozen."""
...
class FedVServer(nn.Module):
    """
    Central server — Client7 Bert+RotatE (7 silos).
