# server.py — Federated server for Client7 RoBERTa+RotatE (7 silos, PQ2H)
#
...
#   - MLP: 768 -> 512 -> 3584
#
# Key dimension difference vs Client7/RoBERTa+TransE and RoBERTa+DistMult:
#   JOINT_DIM = 7 * 2d = 3584  (not 7d = 1792)
...
class QuestionEncoder(nn.Module):
    ...
    RotatE uses 2d-dim entity embeddings -> joint_dim = 14d = 3584.
    MLP: 768 -> 512 -> 3584.
...
class FedVServer(nn.Module):
    """
    Central server — Client7 RoBERTa+RotatE (7 silos).
