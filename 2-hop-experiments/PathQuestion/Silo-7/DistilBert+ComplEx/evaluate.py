# evaluate.py — Evaluation for Client7 DistilBert+ComplEx (7 silos, PQ2H)
...
def evaluate(server, model_a, model_b, model_c, model_d,
    ...
    """7-silo ComplEx evaluation with DistilBERT encoder.
    Each model returns (N, 2d) embeddings; h_joint = (N, 3584)."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results  "
          f"[DistilBERT + ComplEx | PQ2H | Client7 — 7 silos]")
    print(f"{'─'*70}")
