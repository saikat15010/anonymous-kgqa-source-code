# train_fedv.py — Federated QA training ComplEx + RoBERTa (PQ2H | Client7 — 7 silos)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [ComplEx + RoBERTa | PQ2H | Client7 — 7 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (ComplEx+RoBERTa | PQ2H | Client7 | 7 silos)")
    print("=" * 60)
