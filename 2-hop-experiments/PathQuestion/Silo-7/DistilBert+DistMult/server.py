# server.py — Federated server for Client7 DistilBert+DistMult (7 silos, PQ2H)
#
...
#   - MLP: 768 -> 512 -> 1792 (identical shape to DistilBert+TransE)
#
# Structurally identical to Client7/DistilBert+TransE server.py.
# Only config import points to DistilBert+DistMult paths.
...
class QuestionEncoder(nn.Module):
    """DistilBERT [CLS] -> MLP -> q_embed in R^(7d=1792). DistilBERT frozen."""
...
class FedVServer(nn.Module):
    """
    Central server — Client7 DistilBert+DistMult (7 silos).
