# evaluate.py — Evaluation for Client7 DistilBert+DistMult (7 silos, PQ2H)
...
def evaluate(server, model_a, model_b, model_c, model_d,
    ...
    """7-silo DistMult evaluation with DistilBERT encoder."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results  "
          f"[DistilBERT + DistMult | PQ2H | Client7 — 7 silos]")
    print(f"{'─'*70}")
