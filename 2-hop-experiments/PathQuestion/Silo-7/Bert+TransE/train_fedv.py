# train_fedv.py — Federated QA training TransE + BERT (PQ2H | Client7 — 7 silos)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [TransE + BERT | PQ2H | Client7 — 7 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (TransE+BERT | PQ2H | Client7 | 7 silos)")
    print("=" * 60)
