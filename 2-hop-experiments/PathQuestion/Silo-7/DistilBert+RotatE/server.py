# server.py — Federated server for Client7 DistilBert+RotatE (7 silos, PQ2H)
#
...
#   - MLP: 768 -> 512 -> 3584
#
# Key dimension difference vs Client7/DistilBert+TransE and DistilBert+DistMult:
...
class FedVServer(nn.Module):
    """
    Central server — Client7 DistilBert+RotatE (7 silos).
