...
# ComplEx + BERT | 7 silos | 2-hop | Freebase13-enriched KB
#
...
CHECKPOINT_DIR = "/home/islamm9/ISWC/PQ2H/Client7/Bert+ComplEx/models"
...
# BERT output = 768. MLP projects to joint_dim = 7 * 2d = 3584.
