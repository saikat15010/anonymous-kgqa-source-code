# server.py — Federated server for Client7 Bert+ComplEx (7 silos, PQ2H)
#
...
# MLP: 768 -> 512 -> 3584
#
# Structurally identical to Client7/Bert+RotatE server.py.
...
class FedVServer(nn.Module):
    """
    Central server — Client7 Bert+ComplEx (7 silos).
