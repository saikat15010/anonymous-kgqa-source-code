...
class ComplEx(nn.Module):
    ...
    Key advantage over RotatE: relation embeddings are unconstrained
    (no unit-modulus requirement), giving more expressive power.

    Critical for PQ2H Silo A: parents/children are inverses of each
    other — ComplEx models this via the imaginary part asymmetry.
