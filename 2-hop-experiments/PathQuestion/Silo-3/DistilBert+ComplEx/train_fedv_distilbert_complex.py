# train_fedv_distilbert_complex.py — Federated QA training with ComplEx + DistilBERT (PQ2H)
# All results saved to logs_distilbert_complex/run_<timestamp>/fedv_train_log.{txt,json}
...
def train():
    ...
    print(f"\nFederated QA training (ComplEx + DistilBERT | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (ComplEx + DistilBERT | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
