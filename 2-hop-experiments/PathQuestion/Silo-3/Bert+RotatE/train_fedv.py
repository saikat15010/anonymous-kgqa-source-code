# train_fedv.py — Federated QA training with RotatE + BERT (PQ2H)
...
class FedVLogger:
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            f.write("=" * 70 + "\n")
            f.write("  FedV-KGQA  —  Federated QA Training Log  [RotatE + BERT | PQ2H]\n")
...
def train():
    ...
    print(f"\nFederated QA training (RotatE + BERT | PQ2H) — {QA_EPOCHS} epochs | "
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (RotatE + BERT | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
