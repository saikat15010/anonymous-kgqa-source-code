# train_fedv_roberta_rotate.py — Federated QA training with RotatE + RoBERTa (PQ2H)
# All results saved to logs_roberta_rotate/run_<timestamp>/fedv_train_log.{txt,json}
...
def train():
    ...
    print(f"\nFederated QA training (RotatE + RoBERTa | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (RotatE + RoBERTa | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
