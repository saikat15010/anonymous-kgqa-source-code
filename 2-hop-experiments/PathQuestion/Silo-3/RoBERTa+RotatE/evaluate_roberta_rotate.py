# evaluate_roberta_rotate.py — Evaluation for RoBERTa + RotatE experiment (PQ2H)
# Identical logic to all other PQ2H evaluate files.
# Imports USE_TOPIC_ANCHORING from config_roberta_rotate.
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [RoBERTa + RotatE | PQ2H]")
    print(f"{'─'*70}")
