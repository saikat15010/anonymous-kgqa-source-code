# train_fedv_distilbert_distmult.py — Federated QA training with DistMult + DistilBERT (PQ2H)
...
def train():
    ...
    print(f"\nFederated QA training (DistMult + DistilBERT | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (DistMult + DistilBERT | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
