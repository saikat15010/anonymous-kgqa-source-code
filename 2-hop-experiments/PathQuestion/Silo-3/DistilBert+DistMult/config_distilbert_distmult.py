# config_distilbert_distmult.py — Hyperparameters for FedV-KGQA (PQ2H)
# DistMult + DistilBERT | 3 silos | 2-hop | Freebase13-enriched KB
# All parameters identical to Bert+TransE (PQ2H) for fair comparison.

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/PQ2H/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/PQ2H/Client3/DistilBert+DistMult/models"
