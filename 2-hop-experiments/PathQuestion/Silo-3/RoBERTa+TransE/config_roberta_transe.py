# config_roberta_transe.py — Hyperparameters for FedV-KGQA (PQ2H)
# TransE + RoBERTa | 3 silos | 2-hop | Freebase13-enriched KB
# All parameters identical to Bert+TransE (PQ2H) for fair comparison.
# Only change: BERT_MODEL swapped to roberta-base.

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/PQ2H/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/PQ2H/Client3/RoBERTa+TransE/models"
...
#   - Trained on 160GB text, larger batches, no NSP objective
#   - Byte-Pair Encoding (BPE) tokenizer — no token_type_ids
#   - <s> token serves as sequence representation (equivalent to [CLS])
#
