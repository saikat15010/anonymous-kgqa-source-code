# train_fedv_roberta_distmult.py — Federated QA training with DistMult + RoBERTa (PQ2H)
# All results saved to logs_roberta_distmult/run_<timestamp>/fedv_train_log.{txt,json}
...
def train():
    ...
    print(f"\nFederated QA training (DistMult + RoBERTa | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (DistMult + RoBERTa | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
