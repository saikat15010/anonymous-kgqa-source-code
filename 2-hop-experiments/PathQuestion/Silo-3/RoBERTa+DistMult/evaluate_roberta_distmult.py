# evaluate_roberta_distmult.py — Evaluation for RoBERTa + DistMult experiment (PQ2H)
# Identical logic to all other PQ2H evaluate files.
# Imports USE_TOPIC_ANCHORING from config_roberta_distmult.
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [RoBERTa + DistMult | PQ2H]")
    print(f"{'─'*70}")
