# config_distilbert_rotate.py — Hyperparameters for FedV-KGQA (PQ2H)
# RotatE + DistilBERT | 3 silos | 2-hop | Freebase13-enriched KB
# All parameters identical to Bert+TransE (PQ2H) for fair comparison.

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/PQ2H/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/PQ2H/Client3/DistilBert+RotatE/models"
...
# Entity vectors sent to server are 2d-dim; joint_dim = 6d = 1536.
...
# DistilBERT output dim = 768 (same as BERT-base) — MLP input unchanged
# MLP output must match joint_dim = 6d = 1536
