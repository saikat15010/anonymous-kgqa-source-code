# train_fedv_distilbert_rotate.py — Federated QA training with RotatE + DistilBERT (PQ2H)
# All results saved to logs_distilbert_rotate/run_<timestamp>/fedv_train_log.{txt,json}
...
def train():
    ...
    print(f"\nFederated QA training (RotatE + DistilBERT | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (RotatE + DistilBERT | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
