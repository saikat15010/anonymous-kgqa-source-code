# server_distilbert.py — Federated server for DistilBERT + RotatE experiment (PQ2H)
#
# RotatE entity embeddings are 2*embed_dim (complex representation).
# h_joint = [h_A || h_B || h_C] ∈ ℝ^(3 * 2d) = ℝ^(6d) = ℝ^1536
# QuestionEncoder MLP output dim = 6d = 1536  (unlike 3d for TransE/DistMult)
#
...
class FedVServer(nn.Module):
    """
    Central server for DistilBERT + RotatE FedV-KGQA (3 silos, PQ2H).
