# train_fedv.py — Federated QA training with ComplEx + BERT (PQ2H)
...
class FedVLogger:
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            f.write("=" * 70 + "\n")
            f.write("  FedV-KGQA  —  Federated QA Training Log  [ComplEx + BERT | PQ2H]\n")
...
def train():
    ...
    print(f"\nFederated QA training (ComplEx + BERT | PQ2H) — {QA_EPOCHS} epochs | "
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (ComplEx + BERT | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
