# server_roberta_complex.py — Federated server for RoBERTa + ComplEx experiment (PQ2H)
#
...
#
# Structurally identical to server_roberta_rotate.py.
# Only difference: imports from config_roberta_complex.
# Both ComplEx and RotatE use 2d entity embeddings → joint_dim = 6d in both.
...
class FedVServer(nn.Module):
    """
    Central server for RoBERTa + ComplEx FedV-KGQA (3 silos, PQ2H).
