# train_fedv_roberta_complex.py — Federated QA training with ComplEx + RoBERTa (PQ2H)
# All results saved to logs_roberta_complex/run_<timestamp>/fedv_train_log.{txt,json}
...
def train():
    ...
    print(f"\nFederated QA training (ComplEx + RoBERTa | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (ComplEx + RoBERTa | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
