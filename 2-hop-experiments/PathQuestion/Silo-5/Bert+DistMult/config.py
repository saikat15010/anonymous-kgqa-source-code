...
# DistMult + BERT | 5 silos | 2-hop | Freebase13-enriched KB
#
...
CHECKPOINT_DIR = "/home/islamm9/ISWC/PQ2H/Client5/Bert+DistMult/models"
...
# BERT output = 768. MLP projects to joint_dim = 5 * d = 1280.
