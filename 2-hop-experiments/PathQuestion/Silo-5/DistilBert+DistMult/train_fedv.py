# train_fedv.py — Federated QA training DistMult + DistilBERT (PQ2H | Client5 — 5 silos)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [DistMult + DistilBERT | PQ2H | Client5 — 5 silos]\n")
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # DistMult: L2-normalize entity embeddings in all 5 silos
            with torch.no_grad():
                for m in [model_a, model_b, model_c, model_d, model_e]:
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (DistMult+DistilBERT | PQ2H | Client5 | 5 silos)")
    print("=" * 60)
