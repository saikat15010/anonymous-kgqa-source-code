# train_kge.py — Train ComplEx independently on each of the 5 silos (PQ2H | Client5)
#
# ComplEx-specific: Adam optimizer uses weight_decay=1e-6 (standard practice).
# All other hyperparameters identical to all other Client5 experiments.
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training ComplEx — {silo_name}  [Client5 | PQ2H]")
    print(f"{'='*60}")
