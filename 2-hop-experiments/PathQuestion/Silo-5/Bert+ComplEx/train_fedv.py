# train_fedv.py — Federated QA training ComplEx + BERT (PQ2H | Client5 — 5 silos)
...
class FedVLogger:
    def __init__(self, log_dir, config_dict):
        ...
        self.data = {
            ...
            "dataset": "PQ2H", "client": "Client5", "num_silos": 5,
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [ComplEx + BERT | PQ2H | Client5 — 5 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (ComplEx+BERT | PQ2H | Client5 | 5 silos)")
    print("=" * 60)
