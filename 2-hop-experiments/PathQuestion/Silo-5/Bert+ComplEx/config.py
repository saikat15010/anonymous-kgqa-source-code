...
# ComplEx + BERT | 5 silos | 2-hop | Freebase13-enriched KB
#
# KEY DIMENSION (same as RotatE):
...
CHECKPOINT_DIR = "/home/islamm9/ISWC/PQ2H/Client5/Bert+ComplEx/models"
...
# Entity vectors sent to server are 2d-dim; joint_dim = 5 * 2d = 10d = 2560.
