# evaluate.py — Evaluation for Client5 Bert+RotatE (5 silos, PQ2H)
...
def evaluate(server, model_a, model_b, model_c, model_d, model_e,
    ...
    """5-silo RotatE evaluation. Each model returns (N, 2d) embeddings."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results  "
          f"[BERT + RotatE | PQ2H | Client5 — 5 silos]")
    print(f"{'─'*70}")
