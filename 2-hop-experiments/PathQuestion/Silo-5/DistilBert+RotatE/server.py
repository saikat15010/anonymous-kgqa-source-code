# server.py — Federated server for Client5 DistilBert+RotatE (5 silos, PQ2H)
#
...
#   - 768-dim output (same as BERT-base) -> JOINT_DIM unchanged vs Bert+RotatE
#   - MLP: 768 -> 512 -> 2560
#
# vs Client5/Bert+RotatE: only tokenizer/model class changes (DistilBERT vs BERT)
# vs Client5/DistilBert+TransE: JOINT_DIM = 2560 not 1280 (RotatE uses 2d)
...
class FedVServer(nn.Module):
    """
    Central server — Client5 DistilBert+RotatE (5 silos).
