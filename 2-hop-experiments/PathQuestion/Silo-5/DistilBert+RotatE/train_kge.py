# train_kge.py — Train RotatE independently on each of the 5 silos (PQ2H | Client5)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  KGE Training Log"
                    "  [RotatE | PQ2H | Client5 — 5 silos | DistilBERT]\n")
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training RotatE — {silo_name}  [Client5 | DistilBERT+RotatE]")
    print(f"{'='*60}")
