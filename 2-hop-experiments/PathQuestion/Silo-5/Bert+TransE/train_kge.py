# train_kge.py — Train TransE independently on each of the 5 silos (PQ2H | Client5)
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training TransE — {silo_name}  [Client5 | PQ2H]")
    print(f"{'='*60}")
...
def main():
    ...
    # Build shared entity vocabulary across all 5 silos
    ...
    # Train TransE on each of the 5 silos
