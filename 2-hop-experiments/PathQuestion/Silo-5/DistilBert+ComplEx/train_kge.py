...
# ComplEx uses Adam with weight_decay=1e-6 (standard practice).
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  KGE Training Log"
                    "  [ComplEx | PQ2H | Client5 — 5 silos | DistilBERT]\n")
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training ComplEx — {silo_name}  [Client5 | DistilBERT+ComplEx]")
    print(f"{'='*60}")
