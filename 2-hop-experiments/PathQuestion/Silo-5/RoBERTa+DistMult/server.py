# server.py — Federated server for Client5 RoBERTa+DistMult (5 silos, PQ2H)
#
...
#   - MLP: 768 -> 512 -> 1280  (unchanged vs other 1280-dim experiments)
#
# Structurally identical to Client5/RoBERTa+TransE server.py.
# Only difference: config import points to RoBERTa+DistMult paths.
...
class QuestionEncoder(nn.Module):
    ...
    MLP architecture identical to RoBERTa+TransE.
...
class FedVServer(nn.Module):
    """
    Central server — Client5 RoBERTa+DistMult (5 silos).
