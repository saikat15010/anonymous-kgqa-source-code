# server.py — Federated server for Client5 RoBERTa+ComplEx (5 silos, PQ2H)
#
...
#   - MLP: 768 -> 512 -> 2560
#
# Structurally identical to Client5/RoBERTa+RotatE server.py.
# (Both ComplEx and RotatE use 2d entity embeddings -> JOINT_DIM = 2560.)
# Only difference: config import points to RoBERTa+ComplEx paths.
...
class QuestionEncoder(nn.Module):
    ...
    MLP architecture identical to RoBERTa+RotatE.
...
class FedVServer(nn.Module):
    """
    Central server — Client5 RoBERTa+ComplEx (5 silos).
