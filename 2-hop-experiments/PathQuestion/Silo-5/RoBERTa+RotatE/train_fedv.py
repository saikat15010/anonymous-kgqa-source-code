# train_fedv.py — Federated QA training RotatE + RoBERTa (PQ2H | Client5 — 5 silos)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [RotatE + RoBERTa | PQ2H | Client5 — 5 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (RotatE+RoBERTa | PQ2H | Client5 | 5 silos)")
    print("=" * 60)
