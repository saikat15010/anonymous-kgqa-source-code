# train_fedv.py — Federated QA training TransE + DistilBERT (PQ2H | Client5 — 5 silos)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [TransE + DistilBERT | PQ2H | Client5 — 5 silos]\n")
...
def train():
    ...
    print(f"Client5 — 5 silos | joint_dim = 5 x {KGE_EMBED_DIM} = "
          f"{5 * KGE_EMBED_DIM}")
    ...
    print("\nLoading pretrained TransE models (5 silos)...")
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (TransE+DistilBERT | PQ2H | Client5 | 5 silos)")
    print("=" * 60)
