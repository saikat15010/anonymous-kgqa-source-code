# server.py — Federated server for WebQSP Client5 BERT+DistMult (5 silos)
#
# Client5: joint_dim = 5 * entity_dim = 5 * 256 = 1280
# MLP: 768 → 512 → 1280
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client5 BERT+DistMult (5 silos)."""
