# server.py — Federated server for WebQSP Client5 BERT+RotatE (5 silos)
#
# RotatE entity_dim = 2d = 512
# Client5: joint_dim = 5 * 2d = 5 * 512 = 2560
# MLP: 768 → 512 → 2560
#
# Compare with Client5 TransE/DistMult:
#   TransE/DistMult: entity_dim=256, joint_dim=5×256=1280
#   RotatE/ComplEx : entity_dim=512, joint_dim=5×512=2560  ← this file
#
...
class QuestionEncoder(nn.Module):
    """
    BERT [CLS] → MLP → q_embed in R^2560. BERT frozen.
    MLP: 768 → 512 → 2560.
    """
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client5 BERT+RotatE (5 silos)."""
