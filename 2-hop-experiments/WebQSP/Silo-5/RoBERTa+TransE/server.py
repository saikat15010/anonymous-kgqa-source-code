# server.py — Federated server for WebQSP Client5 RoBERTa+TransE (5 silos)
#
...
# Same 768-dim output as BERT/DistilBERT — joint_dim unchanged.
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client5 RoBERTa+TransE (5 silos)."""
