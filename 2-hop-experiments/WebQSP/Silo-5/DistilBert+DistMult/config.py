...
#   - entity_dim and joint_dim unchanged
#
# entity_dim = d = 256
# joint_dim = 5 * d = 1280  (5 silos × 256)
# DistilBERT output = 768-dim  →  MLP: 768 → 512 → 1280

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/WebQSP/data/Client5"
CHECKPOINT_DIR = "/home/islamm9/ISWC/WebQSP/Client5/DistilBert+DistMult/models"
