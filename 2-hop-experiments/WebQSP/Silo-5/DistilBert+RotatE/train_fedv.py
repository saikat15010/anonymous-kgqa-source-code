# train_fedv.py — Federated QA: DistilBERT+RotatE (WebQSP | Client5 — 5 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [DistilBERT + RotatE | WebQSP | Client5 — 5 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [DistilBERT+RotatE | WebQSP | Client5 | 5 silos]")
    print("=" * 60)
