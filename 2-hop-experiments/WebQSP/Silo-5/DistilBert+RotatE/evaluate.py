# evaluate.py — Evaluation for WebQSP Client5 DistilBERT+RotatE (5 silos)
# RotatE: (N, 2d=512) embeddings; h_joint = (N, 5×2d=2560).
...
def evaluate(server, model_a, model_b, model_c, model_d, model_e,
    ...
    """Evaluate with 5 silo RotatE models."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + RotatE | WebQSP | Client5 — 5 silos]")
    print(f"{'─'*70}")
