# server.py — Federated server for WebQSP Client5 DistilBERT+RotatE (5 silos)
#
...
# Same 768-dim output — MLP output (2560) matches BERT+RotatE Client5.
...
class QuestionEncoder(nn.Module):
    """
    DistilBERT [CLS] → MLP → q_embed in R^2560. DistilBERT frozen.
    MLP: 768 → 512 → 2560.
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client5 DistilBERT+RotatE (5 silos)."""
