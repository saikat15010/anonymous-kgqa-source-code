# evaluate.py — Evaluation for WebQSP Client5 DistilBERT+TransE (5 silos)
# TransE: (N, d=256) embeddings; h_joint = (N, 5d=1280).
...
def evaluate(server, model_a, model_b, model_c, model_d, model_e,
    ...
    """Evaluate with 5 silo TransE models."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + TransE | WebQSP | Client5 — 5 silos]")
    print(f"{'─'*70}")
