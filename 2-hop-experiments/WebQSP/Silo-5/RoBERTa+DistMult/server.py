# server.py — Federated server for WebQSP Client5 RoBERTa+DistMult (5 silos)
#
...
# Same 768-dim output — joint_dim and MLP unchanged vs RoBERTa+TransE.
...
class QuestionEncoder(nn.Module):
    """
    RoBERTa [CLS] → MLP → q_embed in R^1280. RoBERTa frozen.
    MLP: 768 → 512 → 1280.
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client5 RoBERTa+DistMult (5 silos)."""
