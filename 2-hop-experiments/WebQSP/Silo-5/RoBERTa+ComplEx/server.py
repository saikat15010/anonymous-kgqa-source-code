# server.py — Federated server for WebQSP Client5 RoBERTa+ComplEx (5 silos)
#
# ComplEx entity_dim = 2d = 512
# Client5: joint_dim = 5 * 2d = 5 * 512 = 2560  (same as RoBERTa+RotatE)
# MLP: 768 → 512 → 2560
#
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client5 RoBERTa+ComplEx (5 silos)."""
