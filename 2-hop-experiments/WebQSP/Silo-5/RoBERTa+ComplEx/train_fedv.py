# train_fedv.py — Federated QA: RoBERTa+ComplEx (WebQSP | Client5 — 5 silos)
#
# QA_EPOCHS = 100.
# 5 silo models — fused to joint_dim = 5 * 2d = 5 * 512 = 2560.
...
# Gradient split: A[0:512], B[512:1024], C[1024:1536], D[1536:2048], E[2048:2560]
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [RoBERTa + ComplEx | WebQSP | Client5 — 5 silos]\n")
...
def train():
    ...
    print(f"Client5 (5 silos) | entity_dim=2d={2*KGE_EMBED_DIM}"
          f" | joint_dim=5×{2*KGE_EMBED_DIM}={5*2*KGE_EMBED_DIM}")
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [RoBERTa+ComplEx | WebQSP | Client5 | 5 silos]")
    print("=" * 60)
