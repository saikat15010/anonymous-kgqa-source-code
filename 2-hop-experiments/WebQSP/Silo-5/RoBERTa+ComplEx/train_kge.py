# train_kge.py — Train ComplEx independently on each of the 5 silos
# WebQSP | Client5 | RoBERTa+ComplEx
#
...
# Checkpoint names: silo_*_complex.pt  (5 checkpoints: a/b/c/d/e)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — KGE Training Log"
                    "  [ComplEx | WebQSP | Client5 | RoBERTa]\n")
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    ...
    print(f"  Training ComplEx — {silo_name.upper()}"
          f"  [WebQSP | Client5 | RoBERTa+ComplEx]")
