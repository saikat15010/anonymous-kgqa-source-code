# train_fedv.py — Federated QA training BERT+RotatE (WebQSP | Client3 — 3 silos)
#
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [BERT + RotatE | WebQSP | Client3 — 3 silos]\n")
...
def train():
    ...
    config_dict = {
        ...
        "entity_dim": 2 * KGE_EMBED_DIM, "joint_dim": 3 * 2 * KGE_EMBED_DIM,
    ...
    print("\nLoading pretrained RotatE models ...")
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [BERT+RotatE | WebQSP | Client3 | 3 silos]")
    print("=" * 60)
