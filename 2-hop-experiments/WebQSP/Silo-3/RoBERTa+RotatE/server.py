# server.py — Federated server for WebQSP Client3 RoBERTa+RotatE (3 silos)
#
# RotatE entity_dim = 2d = 512  →  joint_dim = 3 × 512 = 1536
# MLP: 768 → 512 → 1536
#
# RoBERTa: NO token_type_ids, uses RobertaTokenizer/RobertaModel.
# Same 768-dim output — only MLP output (1536) differs from TransE/DistMult (768).
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client3 RoBERTa+RotatE (3 silos)."""
