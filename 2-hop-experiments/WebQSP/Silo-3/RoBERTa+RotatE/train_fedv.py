# train_fedv.py — Federated QA: RoBERTa+RotatE (WebQSP | Client3 — 3 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [RoBERTa + RotatE | WebQSP | Client3 — 3 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [RoBERTa+RotatE | WebQSP | Client3 | 3 silos]")
    print("=" * 60)
