# train_fedv.py — Federated QA: DistilBERT+DistMult (WebQSP | Client3 — 3 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [DistilBERT + DistMult | WebQSP | Client3 — 3 silos]\n")
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # (TransE/RotatE/ComplEx normalise here; DistMult does not)
