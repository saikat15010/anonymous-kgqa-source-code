...
# DistilBERT output = 768-dim  →  MLP: 768 → 512 → 1536
#
# DistilBERT vs BERT:
#   - 6 transformer layers (vs 12), ~66M params (vs ~110M)
#   - Same 768-dim hidden output → only MLP output dim changes (1536 for RotatE)
#   - No token_type_ids — never pass them to DistilBERT
#
# RotatE vs DistMult/TransE:
#   - entity_dim = 2d = 512  (NOT d = 256)
#   - joint_dim  = 1536       (NOT 768)
#   - Relation embeddings are d phase angles (NOT 2d)
#   - L2 normalisation YES after every gradient step
#
# QA_EPOCHS = 100

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/WebQSP/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/WebQSP/Client3/DistilBert+RotatE/models"
