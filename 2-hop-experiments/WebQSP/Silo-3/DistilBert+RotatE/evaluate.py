# evaluate.py — Evaluation for WebQSP Client3 DistilBERT+RotatE (3 silos)
# RotatE: (N, 2d=512) embeddings; h_joint = (N, 3×2d=1536).
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + RotatE | WebQSP | Client3 — 3 silos]")
    print(f"{'─'*70}")
