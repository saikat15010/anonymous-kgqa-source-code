# server.py — Federated server for WebQSP Client3 DistilBERT+RotatE (3 silos)
#
# RotatE entity_dim = 2d = 512  →  joint_dim = 3 × 512 = 1536
# MLP: 768 → 512 → 1536
#
...
#   4. Same 768-dim output — only MLP output (1536) differs from TransE/DistMult
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client3 DistilBERT+RotatE (3 silos)."""
