# train_kge.py — Train ComplEx independently on each of the 3 silos
# WebQSP | Client3 | BERT+ComplEx
#
# ComplEx: Adam with weight_decay=1e-6 (unique to ComplEx).
# L2 normalise entity embeddings after every gradient step.
# Checkpoint names: silo_*_complex.pt
...
def main():
    ...
    config_dict = {
        ...
        "relation_dim": 2 * KGE_EMBED_DIM,   # 2d (vs d for RotatE)
