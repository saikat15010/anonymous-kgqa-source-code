...
# WebQSP | Client3 | 3 silos | BERT+ComplEx
#
# Entities h, t in C^d stored as 2d reals [Re||Im].
# Relations r ALSO in C^d stored as 2d reals [Re||Im].
# (RotatE uses d phase angles for relations; ComplEx uses 2d.)
#
