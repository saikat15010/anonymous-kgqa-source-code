# server.py — Federated server for WebQSP Client3 BERT+ComplEx (3 silos)
#
# ComplEx entity_dim = 2d = 512  →  joint_dim = 3×512 = 1536
# MLP: 768 → 512 → 1536  (same architecture as RotatE server)
...
class QuestionEncoder(nn.Module):
    """BERT [CLS] → MLP → q_embed in R^1536. BERT frozen. MLP: 768→512→1536."""
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client3 BERT+ComplEx (3 silos)."""
