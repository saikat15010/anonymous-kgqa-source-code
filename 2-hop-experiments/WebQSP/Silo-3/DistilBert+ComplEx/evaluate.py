# evaluate.py — Evaluation for WebQSP Client3 DistilBERT+ComplEx (3 silos)
# ComplEx: (N, 2d=512) embeddings; h_joint = (N, 3×2d=1536).
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + ComplEx | WebQSP | Client3 — 3 silos]")
    print(f"{'─'*70}")
