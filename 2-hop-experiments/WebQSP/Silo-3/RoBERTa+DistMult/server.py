# server.py — Federated server for WebQSP Client3 RoBERTa+DistMult (3 silos)
#
# DistMult entity_dim = d = 256  →  joint_dim = 3 * d = 768
# MLP: 768 → 512 → 768
#
# RoBERTa: NO token_type_ids, uses RobertaTokenizer/RobertaModel.
# Same 768-dim output as BERT — MLP and joint_dim unchanged.
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client3 RoBERTa+DistMult (3 silos)."""
