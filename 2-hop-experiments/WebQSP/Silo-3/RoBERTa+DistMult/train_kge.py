# train_kge.py — Train DistMult independently on each of the 3 silos
# WebQSP | Client3 | RoBERTa+DistMult
#
...
# Checkpoint names: silo_*_distmult.pt
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — KGE Training Log"
                    "  [DistMult | WebQSP | Client3 | RoBERTa]\n")
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    ...
    print(f"  Training DistMult — {silo_name.upper()}"
          f"  [WebQSP | Client3 | RoBERTa+DistMult]")
    ...
    # DistMult: no weight decay (ComplEx uses 1e-6)
