# train_fedv.py — Federated QA: RoBERTa+TransE (WebQSP | Client3 — 3 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [RoBERTa + TransE | WebQSP | Client3 — 3 silos]\n")
...
def train():
    ...
    config_dict = {
        ...
        "joint_dim": 3 * KGE_EMBED_DIM, "roberta_dim": 768,
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [RoBERTa+TransE | WebQSP | Client3 | 3 silos]")
    print("=" * 60)
