# train_fedv.py — Federated QA training BERT+DistMult (WebQSP | Client3 — 3 silos)
#
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [BERT + DistMult | WebQSP | Client3 — 3 silos]\n")
...
def train():
    ...
    config_dict = {
        ...
        "joint_dim": 3 * KGE_EMBED_DIM, "bert_dim": 768,
    ...
    srv_opt      = optim.Adam(server.question_encoder.mlp.parameters(),
                              lr=QA_LR)
    # QA phase: no weight decay for any optimiser
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # DistMult: NO L2 normalisation (TransE/RotatE/ComplEx normalise here)
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [BERT+DistMult | WebQSP | Client3 | 3 silos]")
    print("=" * 60)
