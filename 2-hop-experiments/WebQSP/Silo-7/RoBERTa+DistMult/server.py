# server.py — Federated server for WebQSP Client7 RoBERTa+DistMult (7 silos)
#
# DistMult entity_dim = d = 256
# Client7: joint_dim = 7 * d = 7 * 256 = 1792  (same as TransE)
# MLP: 768 → 512 → 1792
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client7 RoBERTa+DistMult (7 silos)."""
