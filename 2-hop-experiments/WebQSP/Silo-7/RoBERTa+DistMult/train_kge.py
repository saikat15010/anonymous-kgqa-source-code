# train_kge.py — Train DistMult independently on each of the 7 silos
# WebQSP | Client7 | RoBERTa+DistMult
#
...
# Checkpoint names: silo_*_distmult.pt  (7 checkpoints: a/b/c/d/e/f/g)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — KGE Training Log"
                    "  [DistMult | WebQSP | Client7 | RoBERTa]\n")
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    ...
    print(f"  Training DistMult — {silo_name.upper()}"
          f"  [WebQSP | Client7 | RoBERTa+DistMult]")
