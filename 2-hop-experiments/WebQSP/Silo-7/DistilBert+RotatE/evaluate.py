# evaluate.py — Evaluation for WebQSP Client7 DistilBERT+RotatE (7 silos)
# RotatE: (N, 2d=512) embeddings; h_joint = (N, 7×2d=3584).
...
def evaluate(server, model_a, model_b, model_c, model_d,
    ...
    """Evaluate with 7 silo RotatE models."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + RotatE | WebQSP | Client7 — 7 silos]")
    print(f"{'─'*70}")
