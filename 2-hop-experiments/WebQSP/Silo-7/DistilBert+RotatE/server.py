# server.py — Federated server for WebQSP Client7 DistilBERT+RotatE (7 silos)
#
...
# Same 768-dim output — MLP output (3584) doubles vs DistilBERT+TransE/DistMult.
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client7 DistilBERT+RotatE (7 silos)."""
