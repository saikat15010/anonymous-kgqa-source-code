# train_kge.py — Train RotatE independently on each of the 7 silos
# WebQSP | Client7 | DistilBERT+RotatE
#
...
# Checkpoint names: silo_*_rotate.pt  (7 checkpoints: a/b/c/d/e/f/g)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — KGE Training Log"
                    "  [RotatE | WebQSP | Client7 | DistilBERT]\n")
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    ...
    print(f"  Training RotatE — {silo_name.upper()}"
          f"  [WebQSP | Client7 | DistilBERT+RotatE]")
