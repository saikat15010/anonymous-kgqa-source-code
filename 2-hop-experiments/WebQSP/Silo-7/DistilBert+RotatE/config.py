...
# DistilBERT output = 768-dim  →  MLP: 768 → 512 → 3584
#
# RotatE vs DistMult in Client7 (same DistilBERT encoder):
#   DistMult : entity_dim=256, joint_dim=7×256=1792
#   RotatE   : entity_dim=512, joint_dim=7×512=3584  ← this file

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/WebQSP/data/Client7"
CHECKPOINT_DIR = "/home/islamm9/ISWC/WebQSP/Client7/DistilBert+RotatE/models"
