# evaluate.py — Evaluation for WebQSP Client7 DistilBERT+ComplEx (7 silos)
# ComplEx: (N, 2d=512) embeddings; h_joint = (N, 7×2d=3584).
...
def evaluate(server, model_a, model_b, model_c, model_d,
    ...
    """Evaluate with 7 silo ComplEx models."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + ComplEx | WebQSP | Client7 — 7 silos]")
    print(f"{'─'*70}")
