# train_fedv.py — Federated QA: BERT+DistMult (WebQSP | Client7 — 7 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [BERT + DistMult | WebQSP | Client7 — 7 silos]\n")
...
def train():
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [BERT+DistMult | WebQSP | Client7 | 7 silos]")
    print("=" * 60)
