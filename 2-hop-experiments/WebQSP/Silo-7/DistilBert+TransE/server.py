# server.py — Federated server for WebQSP Client7 DistilBERT+TransE (7 silos)
#
...
#   4. Same 768-dim output → joint_dim and MLP unchanged vs BERT+TransE
...
class QuestionEncoder(nn.Module):
    """
    DistilBERT [CLS] → MLP → q_embed in R^1792. DistilBERT frozen.
    MLP: 768 → 512 → 1792.
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client7 DistilBERT+TransE (7 silos)."""
