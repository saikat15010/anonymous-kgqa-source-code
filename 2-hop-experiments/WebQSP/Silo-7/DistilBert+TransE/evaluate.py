# evaluate.py — Evaluation for WebQSP Client7 DistilBERT+TransE (7 silos)
# TransE: (N, d=256) embeddings; h_joint = (N, 7d=1792).
...
def evaluate(server, model_a, model_b, model_c, model_d,
    ...
    """Evaluate with 7 silo TransE models."""
    server.eval()
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + TransE | WebQSP | Client7 — 7 silos]")
    print(f"{'─'*70}")
