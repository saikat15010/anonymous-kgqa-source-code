# train_fedv.py — Federated QA: DistilBERT+TransE (WebQSP | Client7 — 7 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [DistilBERT + TransE | WebQSP | Client7 — 7 silos]\n")
...
def train():
    ...
    config_dict = {
        ...
        "joint_dim": 7 * KGE_EMBED_DIM, "distilbert_dim": 768,
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [DistilBERT+TransE | WebQSP | Client7 | 7 silos]")
    print("=" * 60)
