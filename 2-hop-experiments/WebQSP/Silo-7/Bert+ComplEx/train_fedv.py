# train_fedv.py — Federated QA: BERT+ComplEx (WebQSP | Client7 — 7 silos)
#
# QA_EPOCHS = 100.
...
class FedVLogger:
    def __init__(self, log_dir, config_dict):
        ...
        self.data = {"run_id": os.path.basename(log_dir),
                     "kge_model": "ComplEx", "qa_encoder": "BERT",
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [BERT + ComplEx | WebQSP | Client7 — 7 silos]\n")
...
def train():
    ...
    config_dict = {
        "kge_model": "ComplEx", "qa_encoder": "BERT (bert-base-uncased)",
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [BERT+ComplEx | WebQSP | Client7 | 7 silos]")
    print("=" * 60)
