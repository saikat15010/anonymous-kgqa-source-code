# server.py — Federated server for WebQSP Client7 BERT+RotatE (7 silos)
#
# RotatE entity_dim = 2d = 512
# Client7: joint_dim = 7 * 2d = 7 * 512 = 3584
# (Client5 RotatE had 5*512=2560; Client3 RotatE had 3*512=1536)
#
# MLP: 768 → 512 → 3584
...
class QuestionEncoder(nn.Module):
    """
    BERT [CLS] → MLP → q_embed in R^3584. BERT frozen.
    MLP: 768 → 512 → 3584.
    """
...
class FedVServer(nn.Module):
    """Central server — WebQSP Client7 BERT+RotatE (7 silos)."""
