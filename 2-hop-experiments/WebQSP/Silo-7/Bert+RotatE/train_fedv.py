# train_fedv.py — Federated QA: BERT+RotatE (WebQSP | Client7 — 7 silos)
#
# QA_EPOCHS = 100.
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA — Federated QA Log"
                    "  [BERT + RotatE | WebQSP | Client7 — 7 silos]\n")
...
def train():
    ...
    config_dict = {
        "kge_model": "RotatE", "qa_encoder": "BERT (bert-base-uncased)",
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST  [BERT+RotatE | WebQSP | Client7 | 7 silos]")
    print("=" * 60)
