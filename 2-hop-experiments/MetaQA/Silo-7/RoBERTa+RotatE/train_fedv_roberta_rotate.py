# train_fedv_roberta_rotate.py — Federated QA | RoBERTa + RotatE | 7 silos | Client7
#
...
#   - NO L2 normalisation (RotatE does not need it, unlike TransE/DistMult/ComplEx)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [RotatE + RoBERTa | 7 silos | Client7]\n")
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (RotatE + RoBERTa | 2-hop | 7 silos | Client7)")
    print("=" * 65)
