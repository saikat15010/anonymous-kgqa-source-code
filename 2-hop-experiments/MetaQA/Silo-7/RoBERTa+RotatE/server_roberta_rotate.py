# server_roberta_rotate.py — Federated server | RoBERTa + RotatE | 7 silos | Client7
#
# Differences from Client5 server_roberta_rotate.py (5 silos):
...
class FedVServer(nn.Module):
    """
    Federated server for RoBERTa + RotatE | 7 silos | Client7.
