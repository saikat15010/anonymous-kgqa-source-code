# train_kge_roberta_rotate.py — Train RotatE on 7 silos | RoBERTa | Client7
#
# Differences from Client5 (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB from config_roberta_rotate
...
# Entity embeddings 2d-dim [re|im]; relation embeddings d-dim phase angles.
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training RotatE — {silo_name}  [Client7 | RoBERTa | 7 silos]")
