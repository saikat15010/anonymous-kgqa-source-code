# train_fedv_roberta_distmult.py — Federated QA | RoBERTa + DistMult | 7 silos | Client7
#
# Differences from Client5 (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB
#   - Loads model_f, model_g
#   - 7 optimizers: optim_a … optim_g
#   - server() forward: h_a … h_g (each (N, 256) DistMult embeddings)
#   - Gradient clipping on 7 models
#   - L2 normalisation on 7 models (DistMult standard)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [DistMult + RoBERTa | 7 silos | Client7]\n")
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (DistMult + RoBERTa | 2-hop | 7 silos | Client7)")
    print("=" * 65)
