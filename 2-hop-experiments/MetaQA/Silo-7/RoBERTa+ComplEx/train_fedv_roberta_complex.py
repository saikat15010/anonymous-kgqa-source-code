# train_fedv_roberta_complex.py — Federated QA | RoBERTa + ComplEx | 7 silos | Client7
#
...
#   - L2 normalisation on 7 models (ComplEx standard, unlike RotatE)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [ComplEx + RoBERTa | 7 silos | Client7]\n")
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (ComplEx + RoBERTa | 2-hop | 7 silos | Client7)")
    print("=" * 65)
