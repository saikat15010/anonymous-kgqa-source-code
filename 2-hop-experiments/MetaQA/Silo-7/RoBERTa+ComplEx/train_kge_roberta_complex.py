# train_kge_roberta_complex.py — Train ComplEx on 7 silos | RoBERTa | Client7
#
# Differences from Client5 (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB, KGE_WEIGHT_DECAY from config_roberta_complex
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training ComplEx — {silo_name}  [Client7 | RoBERTa | 7 silos]")
