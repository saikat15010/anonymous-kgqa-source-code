# server.py — Federated server for BERT + TransE | 7 silos | Client7
#
...
#
# TransE entity embeddings are d-dim real vectors (256 per silo).
...
class FedVServer(nn.Module):
    """
    Federated server for BERT + TransE | 7 silos | Client7.
    ...
    def forward(self, questions, topic_ids,
        ...
        """
        h_a … h_g : (N, 256) — TransE entity embeddings from 7 silos
        h_joint   : (N, 1792)
        q_embed   : (B, 1792)
        """
