...
# BERT + TransE | 7 silos | Client7
#
# Differences from Client5 train_kge.py (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB from config
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training TransE — {silo_name}  [Client7 | BERT | 7 silos]")
    print(f"{'='*60}")
