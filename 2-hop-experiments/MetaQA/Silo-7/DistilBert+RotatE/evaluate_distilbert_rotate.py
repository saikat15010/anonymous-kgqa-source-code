# evaluate_distilbert_rotate.py — Evaluation | DistilBERT + RotatE | 7 silos | Client7
#
# Differences from Client5 evaluate_distilbert_rotate.py (5 silos):
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [DistilBERT + RotatE | 7 silos | Client7]")
    print(f"{'─'*70}")
