# train_kge_distilbert_rotate.py — Train RotatE on 7 silos | DistilBERT | Client7
#
# Differences from Client5 (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB from config_distilbert_rotate
...
#
# RotatE: plain Adam (no weight_decay), NO post-step normalisation on entities.
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training RotatE — {silo_name}  [Client7 | DistilBERT | 7 silos]")
