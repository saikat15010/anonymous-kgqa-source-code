# train_fedv_complex.py — Federated QA | BERT + ComplEx | 7 silos | Client7
#
# Differences from Client5 train_fedv_complex.py (5 silos):
...
#   - L2 normalisation on 7 models (ComplEx standard)
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # (unlike RotatE which skips this step)
            with torch.no_grad():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (ComplEx + BERT | 2-hop | 7 silos | Client7)")
    print("=" * 65)
