# server_complex.py — Federated server for BERT + ComplEx | 7 silos | Client7
#
# Differences from Client5 server_complex.py (5 silos):
...
class FedVServer(nn.Module):
    """
    Federated server for BERT + ComplEx | 7 silos | Client7.
