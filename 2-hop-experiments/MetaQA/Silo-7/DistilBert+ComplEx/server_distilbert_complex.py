# server_distilbert_complex.py — Federated server | DistilBERT + ComplEx | 7 silos | Client7
#
# Differences from Client5 server_distilbert_complex.py (5 silos):
...
#
# ComplEx entity embeddings are 2d-dim [re|im]:
...
class FedVServer(nn.Module):
    """
    Federated server for DistilBERT + ComplEx | 7 silos | Client7.
