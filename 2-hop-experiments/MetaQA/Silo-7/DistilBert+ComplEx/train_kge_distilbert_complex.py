# train_kge_distilbert_complex.py — Train ComplEx on 7 silos | DistilBERT | Client7
#
# Differences from Client5 (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB, KGE_WEIGHT_DECAY from config_distilbert_complex
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training ComplEx — {silo_name}  [Client7 | DistilBERT | 7 silos]")
