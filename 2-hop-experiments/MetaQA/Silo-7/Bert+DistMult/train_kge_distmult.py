# train_kge_distmult.py — Train DistMult independently on each of the 7 silos
# BERT + DistMult | 7 silos | Client7
#
# Differences from Client5 train_kge_distmult.py (5 silos):
#   - Imports SILO_F_KB, SILO_G_KB from config_distmult
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training DistMult — {silo_name}  [Client7 | BERT | 7 silos]")
    print(f"{'='*60}")
