# evaluate_distmult.py — Evaluation for BERT + DistMult | 7 silos | Client7
#
# Differences from Client5 evaluate.py (5 silos):
...
from config_distmult import USE_TOPIC_ANCHORING
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [BERT + DistMult | 7 silos | Client7]")
    print(f"{'─'*70}")
