# train_fedv_distmult.py — Federated QA | BERT + DistMult | 7 silos | Client7
#
# Differences from Client5 train_fedv_distmult.py (5 silos):
...
from server_distmult import FedVServer
from evaluate_distmult import evaluate, print_results
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (DistMult + BERT | 2-hop | 7 silos | Client7)")
    print("=" * 65)
