# evaluate_distilbert.py — Evaluation for DistilBERT + TransE | 7 silos | Client7
#
# Differences from Client5 evaluate_distilbert.py (5 silos):
...
from config_distilbert_transe import USE_TOPIC_ANCHORING
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [DistilBERT + TransE | 7 silos | Client7]")
    print(f"{'─'*70}")
