# train_fedv_roberta_transe.py — Federated QA | RoBERTa + TransE | 7 silos | Client7
#
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [TransE + RoBERTa | 7 silos | Client7]\n")
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (TransE + RoBERTa | 2-hop | 7 silos | Client7)")
    print("=" * 65)
