# config_roberta_transe.py — All hyperparameters for FedV-KGQA
# TransE + RoBERTa | 7 silos | 2-hop | Client7

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/Client7/data"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Client7/RoBERTa+TransE/models"
...
# ── TransE KGE ─────────────────────────────────────────────────────────────────
# Scoring: φ(h, r, t) = −||h + r − t||₂  (translation-based)
...
#   - ~125M parameters       (BERT-base: ~110M)
#   - 768-dim hidden output  (same as BERT-base → same MLP input dim)
#   - BPE tokenizer — no token_type_ids, uses <s> as sequence representation
