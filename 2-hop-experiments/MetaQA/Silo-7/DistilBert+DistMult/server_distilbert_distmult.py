# server_distilbert_distmult.py — Federated server | DistilBERT + DistMult | 7 silos | Client7
#
# Differences from Client5 server_distilbert_distmult.py (5 silos):
...
class FedVServer(nn.Module):
    """
    Federated server for DistilBERT + DistMult | 7 silos | Client7.
