# evaluate_distilbert_distmult.py — Evaluation | DistilBERT + DistMult | 7 silos | Client7
#
# Differences from Client5 evaluate_distilbert_distmult.py (5 silos):
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [DistilBERT + DistMult | 7 silos | Client7]")
    print(f"{'─'*70}")
