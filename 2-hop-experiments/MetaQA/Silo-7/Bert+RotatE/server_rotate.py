# server_rotate.py — Federated server for BERT + RotatE | 7 silos | Client7
#
# Differences from Client5 server_rotate.py (5 silos):
...
class FedVServer(nn.Module):
    """
    Federated server for BERT + RotatE | 7 silos | Client7.
