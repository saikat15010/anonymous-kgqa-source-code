# evaluate_rotate.py — Evaluation for BERT + RotatE | 7 silos | Client7
#
# Differences from Client5 evaluate_rotate.py (5 silos):
...
from config_rotate import USE_TOPIC_ANCHORING
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [BERT + RotatE | 7 silos | Client7]")
    print(f"{'─'*70}")
