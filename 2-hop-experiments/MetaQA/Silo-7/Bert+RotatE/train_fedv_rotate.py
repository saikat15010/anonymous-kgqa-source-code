# train_fedv_rotate.py — Federated QA | BERT + RotatE | 7 silos | Client7
#
# Differences from Client5 train_fedv_rotate.py (5 silos):
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            #  which are fixed after Phase 1 and stay in silos)
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (RotatE + BERT | 2-hop | 7 silos | Client7)")
    print("=" * 65)
