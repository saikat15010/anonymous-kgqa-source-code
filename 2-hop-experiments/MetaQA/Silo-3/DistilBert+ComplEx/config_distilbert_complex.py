# config_distilbert_complex.py — Hyperparameters for FedV-KGQA (ComplEx + DistilBERT)
# All parameters identical to all other experiments for fair comparison.
# Changes vs Bert+ComplEx    : CHECKPOINT_DIR, BERT_MODEL → distilbert-base-uncased
# Changes vs DistilBert+RotatE: KGE scoring function (Hermitian dot product vs rotation)
#                               L2 weight_decay=1e-6 on KGE optimizer (standard for ComplEx)
# Absolute paths used to avoid BASE_DIR resolution issues.

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/Client3/data"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Client3/DistilBert+ComplEx/models"
...
# MLP projects: 768 → 512 → 1536  (output matches JOINT_DIM = 6d)
