# src/evaluate.py — Evaluation: MRR, Hits@1/3/5/10 (overall + per answer type)
...
def detect_answer_type(question):
    ...
    Returns one of: 'year' | 'language' | 'genre' | 'person' | 'movie' | 'unknown'
    """
    q = question.lower()
...
def evaluate(server, model_a, model_b, model_c, qa_loader, device,
    ...
    Args:
        per_type : if True, also compute metrics broken down by answer type.
