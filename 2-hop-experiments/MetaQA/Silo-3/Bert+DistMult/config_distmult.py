# config_distmult.py — Hyperparameters for FedV-KGQA (DistMult + BERT)
...
CHECKPOINT_DIR = "/home/islamm9/ISWC/Client3/Bert+DistMult/models"
...
# ── DistMult KGE ───────────────────────────────────────────────────────────────
# All values identical to TransE config for fair comparison
KGE_EMBED_DIM   = 256
KGE_MARGIN      = 1.0
