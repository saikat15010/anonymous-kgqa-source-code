# src/train_fedv_rotate.py — Federated QA training with RotatE + BERT
# All results saved to logs_rotate/run_<timestamp>/fedv_train_log.{txt,json}
...
class FedVLogger:
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            f.write("=" * 70 + "\n")
            f.write("  FedV-KGQA  —  Federated QA Training Log  [RotatE + BERT]\n")
...
def train():
    ...
    print(f"\nFederated QA training (RotatE + BERT) — {QA_EPOCHS} epochs | "
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (RotatE + BERT | 2-hop | 3 silos)")
    print("=" * 60)
