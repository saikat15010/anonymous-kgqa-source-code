# src/server_rotate.py — Federated server for RotatE experiment
#
# Only difference from server.py:
...
from config_rotate import (BERT_MODEL, MLP_HIDDEN_DIMS, MLP_DROPOUT,
...
class FedVServer(nn.Module):
    """
    Central server for RotatE FedV-KGQA (3 silos).
