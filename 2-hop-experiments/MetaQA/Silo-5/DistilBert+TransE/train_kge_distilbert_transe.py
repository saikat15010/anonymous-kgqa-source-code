# train_kge_distilbert_transe.py — Train TransE on 5 silos | DistilBERT | Client5
#
# Differences from Client3 (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB from config_distilbert_transe
#   - Builds shared entity index from 5 silos
#   - Trains 5 silos sequentially
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training TransE — {silo_name}  [Client5 | DistilBERT | 5 silos]")
    print(f"{'='*60}")
