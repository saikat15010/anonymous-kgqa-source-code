# train_fedv_distilbert_transe.py — Federated QA | DistilBERT + TransE | 5 silos | Client5
#
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [TransE + DistilBERT | 5 silos | Client5]\n")
...
def train():
    ...
    print(f"\nFederated QA training (TransE + DistilBERT)"
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (TransE + DistilBERT | 2-hop | 5 silos | Client5)")
    print("=" * 65)
