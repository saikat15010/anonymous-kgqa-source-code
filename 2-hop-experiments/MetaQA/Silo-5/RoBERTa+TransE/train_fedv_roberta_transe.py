# train_fedv_roberta_transe.py — Federated QA | RoBERTa + TransE | 5 silos | Client5
#
# Differences from Client3 (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB
#   - Loads model_d, model_e
#   - 5 optimizers: optim_a … optim_e
#   - server() forward: h_a … h_e  (each (N, 256) TransE embeddings)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [TransE + RoBERTa | 5 silos | Client5]\n")
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (TransE + RoBERTa | 2-hop | 5 silos | Client5)")
    print("=" * 65)
