# server_roberta_transe.py — Federated server | RoBERTa + TransE | 5 silos | Client5
#
# Differences from Client3 server_roberta_transe.py (3 silos):
...
class FedVServer(nn.Module):
    """
    Federated server for RoBERTa + TransE | 5 silos | Client5.
