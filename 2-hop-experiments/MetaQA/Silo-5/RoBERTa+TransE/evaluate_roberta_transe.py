# evaluate_roberta_transe.py — Evaluation | RoBERTa + TransE | 5 silos | Client5
#
# Differences from Client3 evaluate_roberta_transe.py:
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [RoBERTa + TransE | 5 silos | Client5]")
    print(f"{'─'*70}")
