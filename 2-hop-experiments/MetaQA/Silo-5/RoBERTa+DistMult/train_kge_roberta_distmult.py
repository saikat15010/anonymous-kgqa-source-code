# train_kge_roberta_distmult.py — Train DistMult on 5 silos | RoBERTa | Client5
#
# Differences from Client3 (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB from config_roberta_distmult
...
def train_silo(silo_name, kb_path, shared_entity2id, device, logger):
    print(f"\n{'='*60}")
    print(f"  Training DistMult — {silo_name}  [Client5 | RoBERTa | 5 silos]")
    print(f"{'='*60}")
