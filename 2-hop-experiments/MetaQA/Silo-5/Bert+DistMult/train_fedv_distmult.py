# train_fedv_distmult.py — Federated QA training | BERT + DistMult | 5 silos | Client5
#
# Differences from Client3 train_fedv_distmult.py (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB from config_distmult
...
def train():
    ...
    print(f"\nFederated QA training (DistMult + BERT)"
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # DistMult: L2-normalize entity embeddings after each update
            with torch.no_grad():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (DistMult + BERT | 2-hop | 5 silos | Client5)")
    print("=" * 65)
