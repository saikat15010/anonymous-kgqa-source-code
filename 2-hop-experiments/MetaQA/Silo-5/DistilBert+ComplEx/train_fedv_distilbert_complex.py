# train_fedv_distilbert_complex.py — Federated QA | DistilBERT + ComplEx | 5 silos | Client5
#
# Differences from Client3 (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB
#   - Loads model_d, model_e
#   - 5 optimizers: optim_a … optim_e
#   - server() forward: h_a … h_e  (each (N, 512) ComplEx embeddings)
#   - Gradient clipping on 5 models
#   - L2 normalisation on 5 models (ComplEx requires this, unlike RotatE)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [ComplEx + DistilBERT | 5 silos | Client5]\n")
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # (unlike RotatE — ComplEx standard practice)
            with torch.no_grad():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (ComplEx + DistilBERT | 2-hop | 5 silos | Client5)")
    print("=" * 65)
