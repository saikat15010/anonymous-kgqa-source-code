# evaluate_distilbert_distmult.py — Evaluation | DistilBERT + DistMult | 5 silos | Client5
#
# Differences from Client3 evaluate_distilbert_distmult.py:
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [DistilBERT + DistMult | 5 silos | Client5]")
    print(f"{'─'*70}")
