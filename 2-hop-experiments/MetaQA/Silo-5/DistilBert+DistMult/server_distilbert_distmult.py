# server_distilbert_distmult.py — Federated server | DistilBERT + DistMult | 5 silos | Client5
#
# Differences from Client3 server_distilbert_distmult.py (3 silos):
...
# so entity_dim = 256 and joint_dim = 5 * 256 = 1280.
...
class QuestionEncoder(nn.Module):
    ...
    DistMult entity dim = 256 per silo.
    ...
    DistilBERT vs BERT-base:
      ...
      - 768-dim hidden       (identical to BERT-base)
...
class FedVServer(nn.Module):
    """
    Federated server for DistilBERT + DistMult | 5 silos | Client5.
