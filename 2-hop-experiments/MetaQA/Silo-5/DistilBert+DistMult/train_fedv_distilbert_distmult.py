    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [DistMult + DistilBERT | 5 silos | Client5]\n")
...
def train():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (DistMult + DistilBERT | 2-hop | 5 silos | Client5)")
    print("=" * 65)
