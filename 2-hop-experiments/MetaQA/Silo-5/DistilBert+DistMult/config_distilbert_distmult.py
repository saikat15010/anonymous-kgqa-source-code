# config_distilbert_distmult.py — All hyperparameters for FedV-KGQA
# DistMult + DistilBERT | 5 silos | 2-hop | Client5

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/Client5/data"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Client5/DistilBert+DistMult/models"
...
# DistilBERT: 6 layers, 66M params, 768-dim hidden (same as BERT-base output)
