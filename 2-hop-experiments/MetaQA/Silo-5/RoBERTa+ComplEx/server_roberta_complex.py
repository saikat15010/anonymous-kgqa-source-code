# server_roberta_complex.py — Federated server | RoBERTa + ComplEx | 5 silos | Client5
#
# Differences from Client3 server_roberta_complex.py (3 silos):
...
#
# ComplEx entity embeddings: 2d-dim [re|im], entity_dim = 512, joint_dim = 2560
...
class FedVServer(nn.Module):
    """
    Federated server for RoBERTa + ComplEx | 5 silos | Client5.
