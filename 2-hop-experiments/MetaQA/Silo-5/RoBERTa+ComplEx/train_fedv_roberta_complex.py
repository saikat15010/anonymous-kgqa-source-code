# train_fedv_roberta_complex.py — Federated QA | RoBERTa + ComplEx | 5 silos | Client5
#
...
#   - L2 normalisation on 5 models (ComplEx standard)
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [ComplEx + RoBERTa | 5 silos | Client5]\n")
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # (unlike RotatE which skips this)
            with torch.no_grad():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (ComplEx + RoBERTa | 2-hop | 5 silos | Client5)")
    print("=" * 65)
