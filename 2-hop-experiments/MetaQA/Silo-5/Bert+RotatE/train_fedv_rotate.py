# train_fedv_rotate.py — Federated QA training | BERT + RotatE | 5 silos | Client5
#
# Differences from Client3 train_fedv_rotate.py (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB from config_rotate
#   - Loads model_d, model_e in addition to model_a/b/c
#   - 5 entity optimizers: optim_a through optim_e
#   - server() forward call passes h_a … h_e (5 embeddings)
#   - Gradient clipping on 5 ent_embed parameter groups
#   - L2 normalisation on 5 models
#   - build_neighbor_index called with 5 KB paths
#   - evaluate() called with model_a … model_e
#   - _save/_load store model_a … model_e
...
from server_rotate import FedVServer
from evaluate_rotate import evaluate, print_results
...
def train():
    ...
    print(f"\nFederated QA training (RotatE + BERT)"
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # RotatE: L2-normalise entity embeddings after each update
            with torch.no_grad():
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (RotatE + BERT | 2-hop | 5 silos | Client5)")
    print("=" * 65)
