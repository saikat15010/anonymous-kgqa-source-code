# server_rotate.py — Federated server for BERT + RotatE | 5 silos | Client5
#
# Differences from Client3 server_rotate.py (3 silos):
...
class FedVServer(nn.Module):
    """
    Federated server for BERT + RotatE | 5 silos | Client5.
