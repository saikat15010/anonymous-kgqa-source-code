# train_fedv_roberta_rotate.py — Federated QA | RoBERTa + RotatE | 5 silos | Client5
#
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write("  FedV-KGQA  —  Federated QA Training Log"
                    "  [RotatE + RoBERTa | 5 silos | Client5]\n")
...
def train():
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # RotatE: ent_embed.weight ∈ (N, 2d) = (N, 512) [re|im]
            loss, _ = server(
                questions, topic_ids,
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (RotatE + RoBERTa | 2-hop | 5 silos | Client5)")
    print("=" * 65)
