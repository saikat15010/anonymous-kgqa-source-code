# evaluate_roberta_rotate.py — Evaluation | RoBERTa + RotatE | 5 silos | Client5
#
# Differences from Client3 evaluate_roberta_rotate.py:
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [RoBERTa + RotatE | 5 silos | Client5]")
    print(f"{'─'*70}")
