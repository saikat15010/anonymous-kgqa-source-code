# server_roberta_rotate.py — Federated server | RoBERTa + RotatE | 5 silos | Client5
#
# Differences from Client3 server_roberta_rotate.py (3 silos):
...
class QuestionEncoder(nn.Module):
    """
    RoBERTa <s> token → MLP → q_embed ∈ ℝ^2560
...
class FedVServer(nn.Module):
    """
    Federated server for RoBERTa + RotatE | 5 silos | Client5.
