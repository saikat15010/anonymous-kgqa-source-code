# train_fedv_complex.py — Federated QA training | BERT + ComplEx | 5 silos | Client5
#
# Differences from Client3 train_fedv_complex.py (3 silos):
#   - Imports SILO_D_KB, SILO_E_KB from config_complex
...
from server_complex import FedVServer
from evaluate_complex import evaluate, print_results
...
def train():
    ...
    print(f"\nFederated QA training (ComplEx + BERT)"
    ...
    print("\n" + "=" * 65)
    print("  FINAL TEST RESULTS (ComplEx + BERT | 2-hop | 5 silos | Client5)")
    print("=" * 65)
