# evaluate_complex.py — Evaluation for BERT + ComplEx | 5 silos | Client5
#
# Differences from Client3 evaluate_complex.py:
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"\n{'─'*70}")
    print(f"  {split_name} Results  [BERT + ComplEx | 5 silos | Client5]")
    print(f"{'─'*70}")
