# config_complex.py — All hyperparameters for FedV-KGQA
# ComplEx + BERT | 5 silos | 2-hop | Client5

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/Client5/data"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Client5/Bert+ComplEx/models"
...
# ComplEx: Adam with weight_decay=1e-6 (standard L2 regularisation)
KGE_EMBED_DIM    = 256     # complex dim d; real storage = 2*256 = 512
KGE_MARGIN       = 1.0
