# src/train_fedv.py — Federated QA training (TransE + BERT)
...
def train():
    ...
    print(f"\nFederated QA training (TransE + BERT, {NUM_HOPS}-hop)"
    ...
    print("\n" + "=" * 60)
    print(f"  FINAL TEST RESULTS (TransE + BERT | {NUM_HOPS}-hop | 3 silos)")
    print("=" * 60)
