# train_fedv_roberta_transe.py — Federated QA training RoBERTa+TransE
...
def train():
    ...
    print(f"RoBERTa + TransE | {NUM_HOPS}-hop | joint_dim={3*KGE_EMBED_DIM}")
    ...
    print(f"\nFederated QA training (RoBERTa + TransE, {NUM_HOPS}-hop)"
    ...
    print(f"  FINAL TEST RESULTS"
          f" (RoBERTa + TransE | {NUM_HOPS}-hop | 3 silos)")
    print("=" * 60)
