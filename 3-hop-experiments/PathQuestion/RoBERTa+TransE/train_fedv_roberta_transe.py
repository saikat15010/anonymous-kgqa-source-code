# train_fedv_roberta_transe.py — Federated QA training TransE+RoBERTa (PQ3H)
# All results saved to logs_roberta_transe/run_<timestamp>/fedv_train_log.{txt,json}
#
    ...
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            ...
            f.write(f"  FedV-KGQA — Federated QA Training Log"
                    f"  [TransE + RoBERTa | PQ3H | {NUM_HOPS}-hop]\n")
...
def train():
    ...
    print(f"RoBERTa + TransE | PQ3H | {NUM_HOPS}-hop"
    ...
    print("\nLoading pretrained TransE models ...")
    ...
    print(f"\nFederated QA training (RoBERTa + TransE | PQ3H {NUM_HOPS}-hop)"
    ...
    for epoch in range(1, QA_EPOCHS + 1):
        ...
        for batch_idx, (questions, topic_ids,
            ...
            # TransE: L2 normalise entity embeddings every step
            with torch.no_grad():
    ...
    print(f"  FINAL TEST RESULTS"
          f" (RoBERTa + TransE | PQ3H | {NUM_HOPS}-hop | 3 silos)")
    print("=" * 60)
