# config_distilbert_distmult.py — Hyperparameters for FedV-KGQA (PQ3H)
# DistMult + DistilBERT | 3 silos | 3-hop | Freebase13-enriched KB
#
# BASED ON: PQ2H DistilBert+DistMult config
# CHANGES FOR 3-HOP:
...
#
# Same KB structure and silo split as PQ2H — only QA files differ.

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/PQ3H/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/3-hop/PathQuestion/DistilBert+DistMult/models"
