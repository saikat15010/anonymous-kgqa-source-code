...
class QALogger:
    def __init__(self, log_dir, config_dict):
        ...
        self.txt_path  = os.path.join(log_dir, "qa_train_log.txt")
        self.json_path = os.path.join(log_dir, "qa_train_log.json")
        ...
        with open(self.txt_path, "w") as f:
            f.write("=" * 70 + "\n")
            f.write("  Centralized QA Training Log"
