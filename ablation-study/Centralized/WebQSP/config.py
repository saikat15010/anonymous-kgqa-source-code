...
# DistilBERT + TransE | 1 merged KB | 1-2 hop | WebQSP

DATA_DIR       = "/home/islamm9/ISWC/Dataset/WebQSP/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Ablation/Centralized/WebQSP/models"

SILO_KB_PATHS = [
    DATA_DIR + "/silos/kb_silo_a_enriched.txt",
    DATA_DIR + "/silos/kb_silo_b_enriched.txt",
    DATA_DIR + "/silos/kb_silo_c_enriched.txt",
]
