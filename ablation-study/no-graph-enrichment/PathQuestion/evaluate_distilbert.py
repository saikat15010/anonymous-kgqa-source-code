# evaluate_distilbert.py — Evaluation for DistilBERT + TransE experiment (PQ2H)
# Identical logic to Bert+TransE evaluate.py but imports from config_distilbert_transe.
