# evaluate.py — Evaluation for WebQSP Client3 DistilBERT+TransE (3 silos)
# TransE: (N, d=256) embeddings; h_joint = (N, 3d=768).
...
def print_results(split_name, overall, per_type=None):
    ...
    print(f"  {split_name} Results"
          f"  [DistilBERT + TransE | WebQSP | Client3 — 3 silos]")
    print(f"{'─'*70}")
