# train_fedv_distilbert_transe.py — Federated QA training with TransE + DistilBERT (PQ2H)
...
def train():
    ...
    print(f"\nFederated QA training (TransE + DistilBERT | PQ2H) — "
    ...
    print("  FINAL TEST RESULTS"
          " (TransE + DistilBERT | PQ2H | 2-hop | 3 silos)")
    print("=" * 60)
