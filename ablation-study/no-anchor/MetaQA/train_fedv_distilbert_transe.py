# src/train_fedv_distilbert_transe.py — Federated QA training with TransE + DistilBERT
# All results saved to logs_distilbert_transe/run_<timestamp>/fedv_train_log.{txt,json}
...
class FedVLogger:
    def __init__(self, log_dir, config_dict):
        ...
        with open(self.txt_path, "w") as f:
            f.write("=" * 70 + "\n")
            f.write("  FedV-KGQA  —  Federated QA Training Log  [TransE + DistilBERT]\n")
...
def train():
    ...
    print(f"\nFederated QA training (TransE + DistilBERT) — {QA_EPOCHS} epochs | "
    ...
    print("\n" + "=" * 60)
    print("  FINAL TEST RESULTS (TransE + DistilBERT | 2-hop | 3 silos)")
    print("=" * 60)
