# config_distilbert_transe.py — Hyperparameters for FedV-KGQA (TransE + DistilBERT)
# All parameters identical to Bert+TransE for fair comparison.
# Only change: BERT_MODEL swapped to distilbert-base-uncased (768-dim output, ~40% smaller).
# Absolute paths used to avoid BASE_DIR resolution issues.

# ── Paths ──────────────────────────────────────────────────────────────────────
DATA_DIR       = "/home/islamm9/ISWC/Dataset/Client3/data"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Ablation/MetaQA/DistilBert+TransE_no_anchor/models"
...
# ── TransE KGE ─────────────────────────────────────────────────────────────────
# All values identical to Bert+TransE for fair comparison
KGE_EMBED_DIM   = 256
KGE_MARGIN      = 1.0
KGE_NORM        = 2
KGE_LR          = 1e-3
