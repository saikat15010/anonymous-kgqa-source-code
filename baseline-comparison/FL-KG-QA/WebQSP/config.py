# config.py — Adapted FL-KG-QA (VFL) for WebQSP
# Change: CANDIDATE_HOP2_CAP = 0 (1-hop candidates only)

DATA_DIR       = "/home/islamm9/ISWC/Dataset/WebQSP/data/Client3"
CHECKPOINT_DIR = "/home/islamm9/ISWC/Baselines/2_FL_KG_QA/WebQSP/models"
...
USE_TOPIC_ANCHORING = False  # FL-KG-QA has no anchoring mechanism

MAX_NEIGHBORS      = 200
CANDIDATE_HOP1_CAP = 100
CANDIDATE_HOP2_CAP = 0     # ← 1-hop only
