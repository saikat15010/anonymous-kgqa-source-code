# config.py — Adapted Relational Chain Reasoning (VFL) for MetaQA
# Avg pooling, chain reasoning, no topic anchoring
...
USE_TOPIC_ANCHORING = False  # RelChain uses chain reasoning, not anchoring
