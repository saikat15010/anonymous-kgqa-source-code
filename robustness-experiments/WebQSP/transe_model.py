...
# WebQSP | Client5 | 5 silos | BERT+TransE
#
# KGE training is encoder-agnostic — BERT is not involved here.
# Identical scoring logic to Client3 — only dimensions differ at the server.
#
# TransE scoring: phi(h, r, t) = -|| h + r - t ||_2
# entity_dim = d = 256.
# joint_dim = 5 * d = 1280  (set in server.py / config.py).
