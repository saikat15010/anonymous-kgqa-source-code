...
# WebQSP | Client5 | BERT + TransE | 5 silos | 1-2 hop
...
def main():
    ...
    print(f"Noise Robustness Experiment — WebQSP | Client5 | BERT+TransE")
    ...
    print("  WebQSP | Client5 | BERT + TransE | 5 silos")
    print("=" * 70)
    ...
    for sigma in NOISE_SIGMAS:
        r = all_results[sigma]
        output["results"][str(sigma)] = {k: round(v, 6) for k, v in r.items()}
